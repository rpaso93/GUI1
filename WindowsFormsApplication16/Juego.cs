...
namespace WindowsFormsApplication16
{
    class Juego : PictureBox
    {
        ...
        public void juego()
        {
            ...
            spawns.Add(s);
            s = new SpawnPoint(new Point(110, 420), new Size(0, 0));
            spawns.Add(s);
            s = new SpawnPoint(caja2.Location, caja2.Size);
            spawns.Add(s);
            s = new SpawnPoint(new Point(636, 343), new Size(0, 0));
            spawns.Add(s);
            s = new SpawnPoint(caja3.Location, caja3.Size);
            spawns.Add(s);
            s = new SpawnPoint(new Point(800, 535), new Size(0, 0));
            spawns.Add(s);
          ...
          public void agregarDelincuentes(Point pos, int velocidad, double factorTam, int i)
          {
              ...
              this.Controls.Add(d);
              d.Location = pos;
              d.Size = new Size((int)(Properties.Resources.ladronajustado1.Width * factorTam), (int)(WindowsFormsApplication16.Properties.Resources.ladronajustado1.Height * factorTam));
